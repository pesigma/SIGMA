...
public class About extends javax.swing.JFrame {
    ...
    * @param telanterior - Instância da tela anterior. 
     ...
     * @param date 
    */
    public About(MainFrame telanterior, Version ver, Date date) {
        //Chamar construtor
        this();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Desenvolvido em 2016-2017 por");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tolteco/sigma/view/images/Sigma-100x100.png"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        VersionLabel.setText(ver.shortString());
        DateLabel.setText(SDate.DATE_FORMAT_NOTIME.format(date));
