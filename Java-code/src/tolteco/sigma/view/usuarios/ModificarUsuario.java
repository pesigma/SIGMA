 ...
 */
public class ModificarUsuario extends javax.swing.JPanel implements Adicionar<Usuario>{
     ...
     * @param main
     */
    public ModificarUsuario(MainUsuario main) {
        initComponents();
        this.MAIN = main;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("ID de Usuário"));
    ...
    public Usuario getInstance() {
        ...
        return new Usuario((int) idUser.getValue(), nome, level, pass);
    }
}
